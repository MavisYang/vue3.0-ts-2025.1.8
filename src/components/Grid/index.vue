<!--
 * @Author: yangmiaomiao
 * @Date: 2024-01-06 09:02:33
 * @LastEditors: yangmiaomiao
 * @LastEditTime: 2024-02-29 09:54:06
 * @Description: 
-->
<template>
	<div :style="style">
...
const resize = (e: UIEvent) => {
	...
	switch (!!width) {
		case width < 768:
			breakPoint.value = "xs"; //一行 一个选项
			break;
		case width >= 768 && width < 992:
			breakPoint.value = "sm"; //一行 一个选项
			break;
		case width >= 992 && width < 1200:
			breakPoint.value = "md"; //一行 一个选项 展开两个选项
			break;
		case width >= 1200 && width < 1920:
			breakPoint.value = "lg"; //一行 两个选项 展开三个选项
			break;
		case width >= 1920:
			breakPoint.value = "xl";
			break;
	}
	// console.log(width, breakPoint.value, "--------------");
};
...
const findIndex = () => {
	...
	slots.forEach((slot: any) => {
		...
		if (
			...
			(slot.type.__name === "GridItem" || slot.type.name === "GridItem") &&
